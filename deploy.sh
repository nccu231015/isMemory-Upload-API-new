...
gcloud run deploy $SERVICE_NAME \
    ...
    --timeout 3600 \
    --max-instances 10 \
    --set-env-vars "OPENAI_API_KEY=$OPENAI_API_KEY,ASTRA_DB_APPLICATION_TOKEN=$ASTRA_DB_APPLICATION_TOKEN,ASTRA_DB_API_ENDPOINT=$ASTRA_DB_API_ENDPOINT,CLOUDINARY_CLOUD_NAME=$CLOUDINARY_CLOUD_NAME,CLOUDINARY_API_KEY=$CLOUDINARY_API_KEY,CLOUDINARY_API_SECRET=$CLOUDINARY_API_SECRET,X_API_KEY=$X_API_KEY,MS_TOKEN=$MS_TOKEN"
